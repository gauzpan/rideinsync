...
export interface Database {
  public: {
    Tables: {
      ...
      ride_groups: Table<
        { id: string; name: string; city: string | null; culture: string | null; tagline: string | null; rules: string | null; created_by: string } & Timestamps,
        { name: string; city?: string | null; culture?: string | null; tagline?: string | null; rules?: string | null; created_by: string }
      >;
